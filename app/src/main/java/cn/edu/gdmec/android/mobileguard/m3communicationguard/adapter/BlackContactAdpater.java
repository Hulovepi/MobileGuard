...
public class BlackContactAdpater extends BaseAdapter {
    ...
    public BlackContactAdpater(List<BlackContactInfo> systemContacts,Context context){
        super();
    ...
    public View getView(final int i, View view, ViewGroup viewGroup){
        ...
        if(view == null){
            ...
            holder.mContactImgv = view.findViewById(R.id.view_blcak_icon);
            holder.mDeleteView = view.findViewById(R.id.view_blcak_delete);
            view.setTag(holder);
        }else {
        ...
        holder.mDeleteView.setOnClickListener(new View.OnClickListener(){
            ...
            public  void onClick(View view){
                ...
                if (datele){
                    ...
                    BlackContactAdpater.this.notifyDataSetChanged();
                    //如果数据库中没有数据了，则执行回调函数
